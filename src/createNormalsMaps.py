...
def toNormal(texture):
    ...
    im = imageio.imread(input_file, pilmode="RGB")
...
def createNormals(window, textures):
    window['state'].update(value="Generating normal maps")
    i = 1;
    for texture in textures:
        ...
        try:
            ...
            print("Broken png file : " + texture.path + texture.name + texture.ext)
        i = i+1